...
export default function Header({ onToggleDrawer }: HeaderProps) {
  ...
  return (
    <header className="w-full py-4 px-6 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white shadow-xl sticky top-0 z-50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <Link href="/" className="group flex items-center hover:scale-105 transition-transform duration-200" title="Home">
            <div className="relative p-2 rounded-lg bg-white/10 backdrop-blur-sm group-hover:bg-white/20 transition-all duration-200">
              <Image src="/icons/Logo.svg" alt="Logo" width={32} height={32} className="filter brightness-0 invert" />
            </div>
